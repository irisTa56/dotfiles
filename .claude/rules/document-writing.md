...
- A list's lead is a claim too: it says whether the items are the whole set or examples of it. Write the lead the set has.
  - An exclusive lead closes the list whatever qualifier follows it, so a set you cannot exhaust does not take one.
