...
- For a value the change takes in rather than produces, it is what supplying that value settles: the branch the code takes on it, or what a person or an agent reading it does.
