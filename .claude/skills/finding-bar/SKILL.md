...
- For a value the change takes in rather than produces, it is the branch the code takes on that value, or what a reader of it does, and so what its supplier chooses.
