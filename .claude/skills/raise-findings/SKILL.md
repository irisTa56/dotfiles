...
- **A predicate narrower than what its producer emits.** A guard, a match, or a branch condition whose accepted set does not reach every value the thing writing it can produce.
