...
Where the change enumerates conditions, rules, or cases it cannot exhaust, raise a list whose lead takes the entries for the whole set; [document-writing.md](../../rules/document-writing.md#give-a-list-the-shape-its-content-has) governs what a lead claims.
