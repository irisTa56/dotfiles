...
Where the change enumerates conditions, rules, or cases it cannot exhaust, raise a list whose lead takes the entries for the whole set, since its reader stops looking.
