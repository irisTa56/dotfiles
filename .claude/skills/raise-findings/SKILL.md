...
Where the change enumerates conditions, rules, or cases it cannot exhaust, raise a list whose lead takes the entries for the whole set; [document-writing.md](../../rules/document-writing.md) governs what a lead claims.
