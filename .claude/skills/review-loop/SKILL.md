...
- **Who selects the carry-over.** Spawn a fresh subagent synchronously, on the reviewer's tier.
  ...
  - **What it gets**: the record whole, `finding-bar` copied whole to weigh each item against, and no candidates of yours — it derives the carry-over as well as selects it.
